  ...
  <div class="navi" id="fadeshow1" >
     ...
     <section class="navbar custom-navbar navbar-fixed-top" role="navigation" style="top: 38px; ">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="list-group-item" href="Siso.php">SISO</a>
          <a class="list-group-item" href="Simo.php">SIMO</a>
          <a class="list-group-item" href="Sieo.php">SIEO</a>
          <a class="list-group-item" href="grads.php">GRADS</a>
        </div>
      </li>
